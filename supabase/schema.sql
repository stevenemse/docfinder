...
-- ---------------------------------------------------------------------------
-- Revendication « C'est mon document » SANS déclaration préalable : crée la
-- déclaration de perte à la volée, lance le matching puis soumet la
-- revendication si une correspondance couvre le document visé.
-- Voir supabase/migration-claim-with-declaration.sql pour la version autonome.
-- ---------------------------------------------------------------------------
...
BEGIN
  ...
  -- Réutilise une déclaration identique du même citoyen (anti-doublon)
